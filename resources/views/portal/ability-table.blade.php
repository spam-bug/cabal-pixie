<div class="mt-8 overflow-hidden bg-white rounded shadow">
    <div class="flex items-center justify-between p-4 border-b border-gray-200">
        <div class="flex gap-4">
            <button class="font-medium text-gray-700 hover:text-orange-500 focus:text-orange-500 focus:outline-none">
                Essence Runes
            </button>

            <button class="font-medium text-gray-400 hover:text-orange-500 focus:text-orange-500 focus:outline-none">
                Blended Runes
            </button>
        </div>
    ...
    <div class="grid grid-cols-2 p-4 border-b border-gray-200">
        <div class="flex gap-2">
            <div class="w-full">
                <x-input type="text" placeholder="Search keywords" />
            </div>
            ...
            <div x-data="{ expanded: false }" x-on:click.outside="expanded = false">
                <div class="grid grid-cols-[50px_50px_repeat(5,_1fr)] border-b border-gray-200 hover:bg-gray-100 cursor-pointer">
                    ...
                    <div class="flex items-center col-span-2 gap-2 p-4">
                        ...
                        <p class="font-medium text-gray-700">{{ $rune->item->name }}</p>
                    </div>
                    <div class="flex items-center p-4 ">
                        <p class="text-gray-500">{{ $rune->max_level }}</p>
                    </div>
                    <div class="flex items-center p-4 ">
                        <p class="text-gray-500">{{ $rune->total_ap_required }}</p>
                    </div>
                    <div class="flex items-center p-4 ">
